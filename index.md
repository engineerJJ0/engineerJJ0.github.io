...
5. **캐릭터 기능 구현:**
   - 5-1. 이동 (게임시스템디자인의 player.Move 참고)
   - 5-2. 공격 (게임시스템디자인의 player.Attack 참고)
   - 5-3. 쳐내기 (게임시스템디자인의 player.Parry 참고)
   - 5-4. 피격 (게임시스템디자인의 player.Hit 참고)
   - 5-5. 사망 (게임시스템디자인의 player.Die 참고)
   - 5-6. 부활 (게임시스템디자인의 player.Revive 참고)
   - 5-7. 카메라 회전 (마우스 위치값에 따라 카메라 회전, 위아래 회전은 30~-10도로 제한)
   - 5-8. 포션 사용 (게임시스템디자인의 player.UsePotion 참고)
   - 5-9. 애니메이션 (각 행동에 맞는 애니메이션 출력)

6. **적 기능 구현:**
   - 6-1. 이동 (게임시스템디자인의 Enemy.Move 참고)
   - 6-2. 공격 (게임시스템디자인의 Enemy.Attack 참고)
   - 6-3. 플레이어 인식 (게임시스템디자인의 Enemy.FindEnemy 참고)
   - 6-4. 사망 (게임시스템디자인의 Enemy.Die 참고)
   - 6-5. 생성 (게임시스템디자인의 Enemy.Revive 참고)
   - 6-6. 피격 (게임시스템디자인의 Enemy.Hit 참고)
